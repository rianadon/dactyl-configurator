...
<input class="input {clazz ? clazz : (small ? "w-[5.45rem]" : "w-[6.88rem]")}" type="number" value={rounded} step="0.1" on:change={onChange} />
...
<style lang="postcss">
 .input {
     ...
     @apply appearance-none rounded ml-2.5 text-ellipsis px-2;
 }
</style>
