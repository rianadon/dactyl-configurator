...
<table class="mt-4">
  <thead>
    <tr>
      <th></th>
      <th colspan="2" class="text-xl text-teal-500 dark:text-teal-300 font-semibold pb-1 text-left pl-4 {leftStyle}">{level} Left</th>
      <th colspan="2" class="text-xl text-teal-500 dark:text-teal-300 font-semibold pb-1 text-left pl-4 {rightStyle}">{level} Right</th>
      <tr>
        <th></th>
  ...
  <tbody>
    {#each COMPONENTS as component}
      <tr>
        ...
        <td class="{leftStyle}"><FloatInput bind:value={states["thumb" + level + "LeftOffset" + component]}/></td>
        <td class="{leftStyle}"><AngleInput small bind:value={states["thumb" + level + "LeftTenting" + component]}/></td>
        <td class="{rightStyle}"><FloatInput bind:value={states["thumb" + level + "RightOffset" + component]}/></td>
        <td class="{rightStyle}"><AngleInput small bind:value={states["thumb" + level + "RightTenting" + component]}/></td>
      </tr>
    {/each}
</table>
