...
<table class="mt-4">
  <thead>
    <tr>
      <th></th>
      <th colspan="4" class="text-left text-xl text-teal-500 dark:text-teal-300 font-semibold pb-1 pl-4">Stagger</th>
    </tr>
    <tr>
      <th></th>
  ...
  <tbody>
    <tr>
      ...
      <td class="{staggerStyle[0]}"><FloatInput small bind:value={states.thumbClusterOffsetX}/></td>
    ...
    <tr>
      ...
      <td class="{staggerStyle[0]}"><FloatInput small bind:value={states.thumbClusterOffsetY}/></td>
      <td class="{staggerStyle[1]}"><FloatInput small bind:value={states.staggerIndexY}/></td>
      <td class="{staggerStyle[2]}"><FloatInput small bind:value={states.staggerMiddleY}/></td>
      <td class="{staggerStyle[3]}"><FloatInput small bind:value={states.staggerRingY}/></td>
      <td class="{staggerStyle[4]}"><FloatInput small bind:value={states.staggerPinkyY}/></td>
    </tr>
    <tr>
      <th class="font-normal">Z</th>
      <td class="{staggerStyle[0]}"><FloatInput small bind:value={states.thumbClusterOffsetZ}/></td>
      <td class="{staggerStyle[1]}"><FloatInput small bind:value={states.staggerIndexZ}/></td>
      <td class="{staggerStyle[2]}"><FloatInput small bind:value={states.staggerMiddleZ}/></td>
      <td class="{staggerStyle[3]}"><FloatInput small bind:value={states.staggerRingZ}/></td>
      <td class="{staggerStyle[4]}"><FloatInput small bind:value={states.staggerPinkyZ}/></td>
    </tr>
  </tbody>
</table>
...
{#if states.customThumbCluster}
  ...
  <ShapingTable level="Bottom" bind:states={states}
...
<style lang="postcss">
 ...
 .input {
     @apply appearance-none w-[6.88rem] rounded ml-2.5;
     @apply input-basic text-ellipsis;
 }


 .sinput {
     @apply appearance-none w-[5.45rem] rounded ml-2.5;
     @apply input-basic text-ellipsis;
 }
