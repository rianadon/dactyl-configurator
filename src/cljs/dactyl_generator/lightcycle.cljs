(ns dactyl-generator.lightcycle
  ...
  (:require [scad-clj.model :refer [translate cube hull rotate cylinder union mirror extrude-linear polygon sphere difference color sphere-fn cylinder-fn project cut *fn*]]
            [dactyl-generator.util :refer [bottom bottom-hull triangle-hulls deg2rad]]
            [dactyl-generator.common
             :as cmn :refer [screw-insert screw-insert-holes screw-insert-screw-holes screw-insert-outers
                             single-plate sa-cap sa-length sa-double-length web-thickness mount-width mount-height plate-thickness
                             ...
                             wall-thickness sa-profile-key-height
                             ]]))
...
(defn key-place [c column row shape]
  (let [alpha            (get c :configuration-alpha)
        ...
        placed-shape     (->> shape
                              (translate [(wide-pinky c column row) 0 (- (cmn/frow-radius alpha switch-type))])
                              (rotate (* alpha (- 2 row)) [1 0 0])
                              (translate [0 0 (cmn/frow-radius alpha switch-type)])
  ...
  (let [use-lastrow?        (get c :configuration-use-lastrow?)
    ...
    (apply union
           (if-not (or (not (> (last columns) 4))
             ...
             (triangle-hulls (key-place c (last columns) cornerrow (cmn/web-post-tr web-thickness))
                             (key-place c (last columns) cornerrow (cmn/web-post-tl web-thickness))
                             (key-place c (last columns) cornerrow (cmn/web-post-br web-thickness))
                             (key-place c (last columns) cornerrow (cmn/web-post-bl web-thickness)))
             ())
           (concat
          ;; Row connections
  ...
  (let [thumb-count (get c :configuration-thumb-count)]
    (union
     (case thumb-count
       ...
       (union (thumb-place c 0 -0.5 (union shape (extended-plates 2)))
              (thumb-place c 1 -0.5 (union shape (extended-plates 2)))))
     (case thumb-count
       :two ()
...
(defn thumb-connectors [c]
  (let [thumb-count  (get c :configuration-thumb-count)
        use-lastrow? (get c :configuration-use-lastrow?)
        cornerrow    (fcornerrow-lightcycle use-lastrow?)
        thumb-tl     #(->> (cmn/web-post-tl web-thickness)
                           (translate [0 (extended-plate-height %) 0]))
        thumb-bl     #(->> (cmn/web-post-bl web-thickness)
                           (translate [0 (- (extended-plate-height %)) 0]))
        thumb-tr     #(->> (cmn/web-post-tr web-thickness)
                           (translate [0 (extended-plate-height %) 0]))
        thumb-br     #(->> (cmn/web-post-br web-thickness)
                           (translate [0 (- (extended-plate-height %)) 0]))]
    ...
    (union
     ...
     (case thumb-count
       ...
       :six (union
             ...
             (triangle-hulls (thumb-place c 2  0   (thumb-tr 1))
                             ...
                             (thumb-place c 2 -1   (cmn/web-post-br web-thickness)))
             (triangle-hulls (thumb-place c 2  0   (thumb-bl 1))
                             (thumb-place c 2  0   (thumb-br 1))
                             (thumb-place c 2 -1   (cmn/web-post-tl web-thickness))
                             (thumb-place c 2 -1   (cmn/web-post-tr web-thickness))))
       :five (union
              (triangle-hulls (thumb-place c 1  1   (thumb-br 1))
                              (thumb-place c 1  1   (thumb-bl 1))
                              (thumb-place c 1 -0.5 (thumb-tr 2))
     ...
     (case thumb-count
       :two (triangle-hulls (thumb-place c 0 -0.5 (thumb-br 2))
                            ...
                            (key-place   c 1    3 (cmn/web-post-bl web-thickness))
                            (thumb-place c 0 -0.5 (thumb-tr 2))
                            (key-place   c 0    3 (cmn/web-post-br web-thickness))
                            (key-place   c 0    3 (cmn/web-post-bl web-thickness))
                            (thumb-place c 0 -0.5 (thumb-tr 2))
                            (thumb-place c 0 -0.5 (thumb-tl 2))
                            (key-place   c 0    3 (cmn/web-post-bl web-thickness))
                            (thumb-place c 1 -0.5 (thumb-tr 2))
       ...
       :eight (triangle-hulls (thumb-place c 0 -1        (thumb-br 1))
                              ...
                              (key-place   c 0  3        (cmn/web-post-bl web-thickness))
                              (thumb-place c 1  1        (thumb-tr 1))
                              (key-place   c 0  3        (cmn/web-post-tl web-thickness))
                              #_(thumb-place c 0  0        (thumb-tl 1))
                              #_(thumb-place c 1  0        (thumb-tr 1))
                              #_(key-place   c 0  3        (cmn/web-post-bl web-thickness))
                              #_(key-place   c 0  3        (cmn/web-post-tl web-thickness))
                              #_(thumb-place c 1  0        (thumb-tr 1))
                              #_(thumb-place c 1  1        (thumb-tr 1)))
       (triangle-hulls (thumb-place c 0 -0.5      (thumb-br 2))
                       (key-place   c 1 cornerrow (cmn/web-post-bl web-thickness))
                       (thumb-place c 0 -0.5      (thumb-tr 2))
                       (key-place   c 1  4        (cmn/web-post-tl web-thickness))
                       (key-place   c 1  3        (cmn/web-post-bl web-thickness))
                       (thumb-place c 0 -0.5      (thumb-tr 2))
                       (key-place   c 0  3        (cmn/web-post-br web-thickness))
                       (key-place   c 0  3        (cmn/web-post-bl web-thickness))
...
(defn thumb [c]
  (let [thumb-count (get c :configuration-thumb-count)]
    (union
     ...
     #_(case thumb-count
         :five (union
                (thumb-place c 0 -0.5 (extended-plates 2))
                (thumb-place c 1 -0.5 (extended-plates 2)))
    ...
    (union
     ...
     (apply union
            (for [x (range 2 lastrow)]
              (union
               (hull (place (- x 0.5) cornerrow (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
                     (place (+ x 0.5) cornerrow (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
                     (key-place c x cornerrow (cmn/web-post-bl web-thickness))
                     (key-place c x cornerrow (cmn/web-post-br web-thickness)))
               (hull (place (- x 0.5) cornerrow (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
                     (key-place c x cornerrow (cmn/web-post-bl web-thickness))
                     (key-place c (- x 1) cornerrow (cmn/web-post-br web-thickness))))))
     (hull (place (right-wall-column c) cornerrow (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           ...
           (key-place c penultcol cornerrow (cmn/web-post-bl web-thickness))
           (key-place c penultcol cornerrow (cmn/web-post-br web-thickness)))
     (hull (place (+ antecol 0.5) cornerrow (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           (place (- (right-wall-column c) 1) cornerrow (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           (key-place c antecol cornerrow (cmn/web-post-br web-thickness))
           (key-place c penultcol cornerrow (cmn/web-post-bl web-thickness)))
  ...
  (let [ncols                   (get c :configuration-ncols)
    ...
    (union
     ...
     (hull (place left-wall-column (back-y c) (translate [1 -1 1] (wall-sphere-bottom-back thick-wall?)))
           ...
           (key-place c 0 back-row (cmn/web-post-tl web-thickness))
           (key-place c 0 back-row (cmn/web-post-tr web-thickness)))
     ...
     (hull (place penultcol (back-y c) (translate [0 -1 1] (wall-sphere-bottom-back thick-wall?)))
           ...
           (key-place c penultcol back-row (cmn/web-post-tl web-thickness))
           (key-place c penultcol back-row (cmn/web-post-tr web-thickness)))

     (apply union
            (for [x (range 1 penultcol)]
              (union
               (hull (place (- x 0.5) (back-y c) (translate [0 -1 1] (wall-sphere-bottom-back thick-wall?)))
                     (place (+ x 0.5) (back-y c) (translate [0 -1 1] (wall-sphere-bottom-back thick-wall?)))
                     (key-place c x back-row (cmn/web-post-tl web-thickness))
                     (key-place c x back-row (cmn/web-post-tr web-thickness)))
               (hull (place (- x 0.5) (back-y c) (translate [0 -1 1] (wall-sphere-bottom-back thick-wall?)))
                     (key-place c x back-row (cmn/web-post-tl web-thickness))
                     (key-place c (- x 1) back-row (cmn/web-post-tr web-thickness))))))
     (hull (place (- 4 0.5) (back-y c) (translate [0 -1 1] (wall-sphere-bottom-back thick-wall?)))
           (place penultcol (back-y c) (translate [0 -1 1] (wall-sphere-bottom-back thick-wall?)))
           (key-place c antecol back-row (cmn/web-post-tr web-thickness))
           (key-place c penultcol back-row (cmn/web-post-tl web-thickness))))))
     ...
     (apply union
            (concat
             (for [x (range (if use-numrow? 0 1) lastrow)]
               (union
                (hull (place (right-wall-column c) x (translate [-1 0 1] (wall-sphere-bottom thick-wall? 0.5)))
                      (key-place c penultcol x (cmn/web-post-br web-thickness))
                      (key-place c penultcol x (cmn/web-post-tr web-thickness)))))
             (for [x (range (if use-numrow? 0 1) cornerrow)]
               (union
                (hull (place (right-wall-column c) x (translate [-1 0 1] (wall-sphere-bottom thick-wall? 0.5)))
                      (place (right-wall-column c) (inc x) (translate [-1 0 1] (wall-sphere-bottom thick-wall? 0.5)))
                      (key-place c penultcol x (cmn/web-post-br web-thickness))
                      (key-place c penultcol (inc x) (cmn/web-post-tr web-thickness)))))
             [(union
               (hull (place (right-wall-column c) (first rows) (translate [-1 0 1] (wall-sphere-bottom thick-wall? 0.5)))
                     (place (right-wall-column c) (back-y c) (translate [-1 -1 1] (wall-sphere-bottom thick-wall? 1)))
                     (key-place c penultcol (first rows) (cmn/web-post-tr web-thickness)))
               (hull (place (right-wall-column c) cornerrow (translate [-1 0 1] (wall-sphere-bottom thick-wall? 0.5)))
    ...
    (union
     ...
     (if use-numrow?
       (color [0 0 1] (hull (place left-wall-column 0 (translate [1 -1 1] (wall-sphere-bottom-back thick-wall?)))
                            ...
                            (translate [1 0 0] (key-place c 0 0 (cmn/web-post-tl web-thickness)))
                            (key-place c 0 1 (cmn/web-post-tl web-thickness))))
       ())
     (color [0 1 0] (hull (place left-wall-column 1 (translate [1 -1 1] (wall-sphere-bottom-back thick-wall?)))
                          ...
                          (place left-wall-column 2 (translate [1 0 1] (wall-sphere-bottom-back thick-wall?)))
                          (translate [0 0 0] (key-place c 0 1 (cmn/web-post-tl web-thickness)))
                          (key-place c 0 1 (cmn/web-post-bl web-thickness))
                          (key-place c 0 2 (cmn/web-post-tl web-thickness))))
     (color [0.8 1 0] (hull (place left-wall-column 2 (translate [1 -1 1] (wall-sphere-bottom-back thick-wall?)))
                            (place left-wall-column 2 (translate [1  0 1] (wall-sphere-bottom-back thick-wall?)))
                            (key-place c 0 2 (cmn/web-post-tl web-thickness))
                            (key-place c 0 2 (cmn/web-post-bl web-thickness))
     ...
     (case thumb-count
       ...
       (color [0 0 0] (hull (place left-wall-column finish-left-wall  (translate [1 0 1] (wall-sphere-bottom-front thick-wall?)))
                            (thumb-place c 1 thumb-where (cmn/web-post-tr web-thickness))
                            (place left-wall-column finish-left-wall  (translate [1 -1 1] (wall-sphere-bottom-front thick-wall?)))
                            (key-place   c 0 3 (case thumb-count :two (cmn/web-post-bl web-thickness) (cmn/web-post-tl web-thickness)))))))))
     ...
     (apply union
            (for [x (range-inclusive 0.5 (- (+ thumb-range 0.05) step) step)]
              (bottom-hull (thumb-place c x local-back-y (wall-sphere-bottom-back thick-wall?))
                           (thumb-place c (+ x step) local-back-y (wall-sphere-bottom-back thick-wall?)))))
     (hull (thumb-place c 0.5 local-back-y (wall-sphere-top-back thick-wall? use-border?))
           (thumb-place c 0.5 local-back-y (wall-sphere-bottom-back thick-wall?))
           (case-place  c left-wall-column thumb-back-to-left-wall-position (wall-sphere-top-front thick-wall? use-border?)))
     (hull (thumb-place c 0.5 local-back-y (wall-sphere-bottom-back thick-wall?))
           (case-place  c left-wall-column thumb-back-to-left-wall-position (wall-sphere-top-front thick-wall? use-border?))
           (case-place  c left-wall-column thumb-back-to-left-wall-position (wall-sphere-bottom-front thick-wall?)))
     (bottom-hull (thumb-place c 0.5 local-back-y (wall-sphere-bottom-back thick-wall?))
                  (case-place  c left-wall-column thumb-back-to-left-wall-position (wall-sphere-bottom-front thick-wall?)))
     (hull
      (thumb-place c 0.5 (thumb-back-y c) (wall-sphere-bottom-back thick-wall?))
      (thumb-place c 1 back-thumb-position (cmn/web-post-tr web-thickness))
      (thumb-place c (/ 3 2) (thumb-back-y c) (wall-sphere-bottom-back thick-wall?))
      (thumb-place c 1 back-thumb-position (cmn/web-post-tl web-thickness)))
     (hull
     ...
     (case thumb-count
       ...
       (union (hull (place (thumb-left-wall-column c) 1.95 (wall-sphere-top-front thick-wall? use-border?))
              ...
              (hull (place (thumb-left-wall-column c) (thumb-back-y c) (translate [1 -1 1] (wall-sphere-bottom-back thick-wall?)))
                    ...
                    (place column 1 (cmn/web-post-tl web-thickness))
                    (place column 1 (cmn/web-post-bl web-thickness)))
              (hull (place (thumb-left-wall-column c) 0 (translate [1 0 1] (wall-sphere-bottom-back thick-wall?)))
                    (place column 0 (cmn/web-post-tl web-thickness))
                    (place column 1 (cmn/web-post-bl web-thickness)))))
     (hull
      ...
      (place column 0 (cmn/web-post-tl web-thickness))
      (place column 0 (cmn/web-post-bl web-thickness)))
     (hull
      (place (thumb-left-wall-column c) -1 (translate [1 0 1] (wall-sphere-bottom-back thick-wall?)))
      (place column -1 (cmn/web-post-tl web-thickness))
      (place column 0 (cmn/web-post-bl web-thickness)))
  ...
  (let [thumb-count  (get c :configuration-thumb-count)
    ...
    (union
     ...
     (hull (place thumb-right-wall thumb-front-row (wall-sphere-bottom-front thick-wall?))
           ...
           (place 0 -0.5 (cmn/web-post-br web-thickness))
           (case-place c 0.7 cornerrow (wall-sphere-bottom-front thick-wall?)))

     (hull (place thumb-right-wall thumb-front-row (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           (place (+ 0.5 0.05) thumb-front-row (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           (place 0 -1   (cmn/web-post-bl web-thickness))
           (place 0 -1   (cmn/web-post-br web-thickness)))
     (hull (place (+ 0.5 0.05) thumb-front-row (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           (place (+ (/ 3 2) 0.05) thumb-front-row (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
           (place 0 -1   (cmn/web-post-bl web-thickness))
           (place 1 -1   (cmn/web-post-bl web-thickness))
           (place 1 -1   (cmn/web-post-br web-thickness)))
     (case thumb-count
       :two ()
       :three ()
       (hull (place (+ (/ 3 2) 0.05) thumb-front-row (translate [0 1 1] (wall-sphere-bottom-front thick-wall?)))
             ...
             (place 2            -1              (cmn/web-post-bl web-thickness)))))))
